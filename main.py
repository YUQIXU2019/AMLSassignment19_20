...
if __name__ == '__main__':
    ...
    # Task A1
    # SVM for task A1
    #pred_A1_SVM, acc_A1_test_SVM, val_acc_A1_SVM = A1_SVM.img_SVM(A1_tr_X.reshape((3000, 68*2)), list(zip(*A1_tr_Y))[0], A1_add_te_X.reshape((969, 68*2)), list(zip(*A1_add_te_Y))[0])
