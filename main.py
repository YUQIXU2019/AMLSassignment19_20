...
if __name__ == '__main__':
    ...
    # Task A1
    # SVM for task A1
    #pred_A1_SVM, acc_A1_test_SVM, val_acc_A1_SVM = A1_SVM.img_SVM(A1_tr_X.reshape((3000, 68*2)), list(zip(*A1_tr_Y))[0], A1_te_X.reshape((1800, 68*2)), list(zip(*A1_te_Y))[0])
    #acc_A1_train_SVM = val_acc_A1_SVM.mean()
    # MLP for task A1
    #pred_A1_MLP, acc_A1_train_MLP, val_acc_A1_MLP, acc_A1_test_MLP = A1_MLP.MLP_A1(training_images, training_labels, test_images, test_labels, val_images, val_labels)
    ...
    # Task A2
    #pred_A2_SVM, acc_A2_test_SVM, val_acc_A2_SVM = A2_SVM.img_SVM(A2_tr_X.reshape((3000, 68*2)), list(zip(*A2_tr_Y))[0], A2_te_X.reshape((1800, 68*2)), list(zip(*A2_te_Y))[0])
